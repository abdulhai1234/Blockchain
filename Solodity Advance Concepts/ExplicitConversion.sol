...
// explicit conversoin is required when a compiler does not
// perform implicit conversion, either because of a loss of data
// or a value containing data not falling within a target data type range
// syntax for explicit conversion: type(identifier)
